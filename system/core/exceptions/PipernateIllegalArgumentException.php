...
class PipernateIllegalArgumentException extends PipernateException
{
    ...
    private $error = Array(
        ...
        9008 => "Order By missing parameter exception,it gives two param, these parameters
 		 are column and orderType, order type default value 'ASC', probably column not found.",
        9009 => "Distinct missing parameter exception,it gives two param, these parameters
